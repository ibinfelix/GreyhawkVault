...
image: [[flanaeass.png]] ### Link to the map image file. Do not add a ! in front of the image  
...
maxZoom: 1.3 ### Controls how far towards the map you can zoom in. Hover over the target icon to see the current level.  
